...
By: Alex Omid-Zohoor based on PS2000 demo by Colin O'Flynn, based on Mark Harfouche's software

This is a demo of how to use AWG with the Picoscope 5443 along with capture
It was tested with the PS5443B USB2.0 version
...
if __name__ == "__main__":
    ...
    ps.setSigGenBuiltInSimple(offsetVoltage=0, pkToPk=1.2, waveType="Sine", frequency=50E2)
    ...
    plt.title("Picoscope 5000 waveforms")
